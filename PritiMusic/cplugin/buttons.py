...
def panel_markup_3(_, videoid, chat_id):
    buttons = [
        ...
        [InlineKeyboardButton(text="CLONE NOW", url="https://t.me/clone_MUSICrobot")],
        [InlineKeyboardButton(text="BACK", callback_data=f"Pages Back|2|{videoid}|{chat_id}")],
    ]
    return InlineKeyboardMarkup(buttons)
...
def panel_markup_4(_, vidid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text="CLONE NOW", url="https://t.me/clone_MUSICrobot")],
        [InlineKeyboardButton(text="HOME", callback_data=f"MainMarkup {vidid}|{chat_id}")],
    ]
    return InlineKeyboardMarkup(buttons)
...
def panel_markup_5(_, videoid, chat_id, bot_username):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="HOME", callback_data=f"MainMarkup {videoid}|{chat_id}"),
            InlineKeyboardButton(text="NEXT", callback_data=f"Pages Forw|1|{videoid}|{chat_id}"),
        ],
    ]
    return InlineKeyboardMarkup(buttons)
